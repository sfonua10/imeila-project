          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              ...
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Top notch software engineers capable of solving and providing solutions to technical challenges and tasks. Work with top talented developers in the tech industry. Scale your business with experienced and capable developers ready to make an impact and dramatic difference.
              </p>
